...
app_identifier "de.Kevin-Meyer.Wallabag"
version '0.12.1' # you can pass this if you want to verify the version number with the ipa file
...
# ipa do
    ...
    # "./ios-app.ipa" # Tell 'Deliver' where it can find the finished ipa file
# end
